  ...
  return (
    <main className="min-h-screen bg-forge-bg flex flex-col items-center justify-center px-6">
      <div className="text-center max-w-md">
        <p className="text-forge-accent text-xs font-mono tracking-widest mb-3 uppercase">
          Northform
        </p>
        ...
        <p className="text-forge-muted text-sm mb-8">
          ...
          <code className="text-forge-accent font-mono">/[client-slug]</code>
        </p>
        <Link
          href="/northformqa"
          className="text-sm text-forge-muted hover:text-forge-accent transition-colors"
        >
          → northformqa demo
        </Link>
      </div>
